    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('superadmin.leaveApplication.store')}}" method="post" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Select Leave Type') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('End Date') }}</label>
                            <div class="col-md-6">
                                <input type="date"  class="form-control" name="end_date" placeholder="{{old('end_date')}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Reason For Leave') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <a class="btn btn-primary m-t-15 waves-effect" href="{{route('superadmin.leaveApplication.index')}}"> Back</a>
