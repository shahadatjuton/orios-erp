...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header text-center"><h2> Apply For Job </h2></div>
                ...
                <div class="card-body">
                    <form action="{{route('applicant.application.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-float">
                            ...
                            <div class="form-line">
                                <input type="file"  class="form-control" name="cv" placeholder="{{old('cv')}}">
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <label for="">Describe Yourself</label>
                            <div class="body">
                                <textarea id="tinymce" name="description" rows="6" cols="116"></textarea>
                            </div>
                        </div>
